...
def upsampler(input_shape, output_depth):
  inputs = Input(shape=input_shape)
  x = layers.Conv2DTranspose(128, 3, activation='relu', padding='same')(inputs)
  x = layers.LeakyReLU()(x)

  x = layers.Conv2DTranspose(64, 3, activation='relu', padding='same')(x)
  x = layers.LeakyReLU()(x)

  x = layers.Conv2DTranspose(output_depth, 3, activation='relu', padding='same')(x)
