...
PID = {"kP":70, "kI":40, "kD":10, "iZone":0.15} # Implement IZone in display
controller = PIDController(Kp=PID["kP"], Ki=PID["kI"], Kd=PID["kD"], IZone=PID["iZone"], output_clamp=(-15, 15))
...
while True:
    ...
    if temp_PID != None:
        PID = temp_PID
    controller.update_gains(Kp=PID["kP"], Ki=PID["kI"], Kd=PID["kD"], IZone=PID["iZone"])
