...
class Chopper(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        self.icon = cv2.imread("/home/aoberai/programming/implementations/ppo/custom_env/imgs/chopper.png") / 255.0
        self.icon_w = 64
        self.icon_h = 64
...
class Bird(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        self.icon = cv2.imread("/home/aoberai/programming/implementations/ppo/custom_env/imgs/bird.png") / 255.0
        self.icon_w = 32
        self.icon_h = 32
        self.icon = cv2.resize(self.icon, (self.icon_h, self.icon_w))
...
class Fuel(Point):
    def __init__(self, name, x_max, x_min, y_max, y_min):
        ...
        self.icon = cv2.imread("/home/aoberai/programming/implementations/ppo/custom_env/imgs/fuel.png") / 255.0
        self.icon_w = 32
        self.icon_h = 32
        self.icon = cv2.resize(self.icon, (self.icon_h, self.icon_w))
...
class ChopperScape(gym.Env):
    ...
    def step(self, action):
        ...
        return self.canvas, reward, done, done, {}
# env = ChopperScape()
# obs = env.reset()
