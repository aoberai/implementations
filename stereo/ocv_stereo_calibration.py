# https://github.com/aliyasineser/stereoDepth/blob/master/stereo_camera_calibration.py
...
import argparse
import sys
from ocv_calib_store import load_coefficients, save_stereo_coefficients
...
def stereo_calibrate(left_file, right_file, left_dir, left_prefix, right_dir, right_prefix, image_format, save_file, square_size, width=9, height=7):
...
def load_image_points(left_dir, left_prefix, right_dir, right_prefix, image_format, square_size, width=9, height=7):
    global image_size
